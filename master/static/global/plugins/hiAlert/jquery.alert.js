(function(a) {
    a.alerts = {
        ...
        _overShow: function(d, c) {
            ...
            var e = (navigator.userAgent.match(/msie/i) && parseInt(a.browser.version) <= 6) ? "absolute" : "fixed";
        ...
        _overReposition: function() {
            ...
            if (navigator.userAgent.match(/msie/i) && parseInt(a.browser.version) <= 6) {
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            var i = (navigator.userAgent.match(/msie/i) && parseInt(a.browser.version) <= 6) ? "absolute" : "fixed";
